...
class LightDesk(threading.Thread):
    ...
    def add_controls_and_groups(self):
        GroupRow(name='T', description="Other     ", light_desk=self,
        ...
        GroupRow(name='C', description="Floor     ", light_desk=self,
                 cols=[[{'name': 'DimM', 'description': '', 'hue': 0.00, 'sat': 0.0,
        ...
        self.controls_push.left_tap_tempo.set_light(4)
